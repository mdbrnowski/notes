...
\begin{definition}[szereg Taylora]
    ...
    nazywamy szeregiem Taylora. Jeśli $x_0 = 0$, to nazywamy go szeregiem Maclaurina. Taki szereg jest niemal jednostajnie zbieżny (na pewnym przedziale) do funkcji $f$.
\end{definition}
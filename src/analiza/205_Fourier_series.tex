...
\begin{proof}
    ...
    \begin{align*}
        ...
        \intertext{
            Wybierzmy dowolne $m \in \mathbb{N}$.
        }
        f(x) \cdot \varphi_m (x)
        &= \sum_{n=0}^\infty c_n \varphi_n(x) \cdot \varphi_m(x) \\
        \int_a^b f(x) \varphi_m(x) dx
        &= \sum_{n=0}^\infty c_n \int_a^b \varphi_n(x) \varphi_m(x) dx \\
        \intertext{
            Ponieważ $(\varphi_n)_{n \in \mathbb{N}}$ jest ciągiem ortogonalnym
            (czyli dla $n \neq m$, $\int_a^b \varphi_n(x) \varphi_m(x) = 0$),
            suma sprowadza się do:
        }
        \int_a^b f(x) \varphi_m(x) dx
        &= \sum_{n=0}^\infty c_n \int_a^b \varphi_n(x) \varphi_m(x) dx \\
        &= c_m \int_a^b \varphi_m(x) \varphi_m(x) dx \\
        f \circ \varphi_m

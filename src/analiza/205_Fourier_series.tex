...
Sumę szeregu $1 + \frac{1}{3^2} + \frac{1}{5^2} + \ldots$ dało się też znaleźć rozwijając inne funkcje, np. $f(x) = |x|$ (jest parzysta, więc obliczenia byłyby w tym przypadku krótsze).

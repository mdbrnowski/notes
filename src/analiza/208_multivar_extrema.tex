...
\begin{theorem}[Sylvestera]
    ...
    \begin{enumerate}
        ...
        \item w innym wypadku $\varphi$ jest niookreślona
    \end{enumerate}
\end{theorem}
...
\begin{definition}[hesjan]
    ...
    \end{bNiceMatrix} \]
    nazywamy \vocab{macierzą Hessego} funkcji $f$ w punkcie $p$. Jej wyznacznik nazywamy hesjanem tej funkcji w $p$.
\end{definition}
...
\end{example}
\begin{solution}
    Weźmy punkt $P \in \pi$. Wtedy $P = (x, xz, z)$, a odłegłość tego punktu od punktu $A$ wyraża się wzorem

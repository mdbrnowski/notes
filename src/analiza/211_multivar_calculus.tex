Całki wielokrotne definiujemy analogicznie do całek jednej zmiennej: rozcinamy obszar na coraz drobniejsze prostokąty (a w trzech wymiarach na coraz drobniejsze prostopadłościany), w każdym bierzemy wartość funkcji w wybranym punkcie i tworzymy sumy odpowiadające im objętości. Istotne jest, że rozważamy tylko takie podziały, których średnica (czyli największy rozmiar elementu podziału) dąży do zera. Jeżeli przy takim zagęszczaniu podziału te sumy dążą do jednej liczby niezależnej od sposobu wyboru punktów, to tę liczbę nazywamy całką funkcji po danym obszarze.

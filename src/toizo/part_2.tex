...
\end{theorem}
\begin{proof}
    Problem \textsc{Clique} na grafie $G$ jest równoważny problemowi \textsc{Independent Set} na $\ol{G}$ (dopełnieniu grafu $G$). Zbiór $k$ wierzchołków niezależnych w grafie $\ol{G}$ odpowiada zbiorowi $k$ wierzchołków tworzących klikę w grafie $G$.
\end{proof}

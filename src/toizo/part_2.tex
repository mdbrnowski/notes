...
\begin{definition}
    Rekurencyjnie definiujemy klasy $\Sigma_i^\Pclass$, $\Pi_i^\Pclass$ i $\Delta_i^\Pclass$:
    \[ \Sigma_0^\Pclass = \Pi_0^\Pclass = \Delta_0^\Pclass = \Pclass, \]
    \[ \Sigma_i^\Pclass = \NPclass^{\Sigma_{i-1}^\Pclass}, \]
    \[ \Pi_i^\Pclass = \coNPclass^{\Sigma_{i-1}^\Pclass}, \]
    \[ \Delta_i^\Pclass = \Pclass^{\Sigma_{i-1}^\Pclass}. \]
    Ponadto,
    \[ \PHclass = \bigcup_{i \in \NN} \Sigma_i^\Pclass. \]
\end{definition}

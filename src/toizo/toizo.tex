...
% LTeX: language=pl-PL
\documentclass[pretty,polish,bibliography=totocnumbered]{angav}
...
\begin{document}
    ...
    \input{reduction_graph.tex}
    \input{part_1.tex}
    \input{part_2.tex}

    \begin{thebibliography}{9}
        \bibitem{Adleman} L. M. Adleman, M. C. Loui (1981). Space-bounded simulation of multitape Turing machines. \textit{Mathematical Systems Theory, 14}, 215--222.
        \bibitem{AroraBarak} S. Arora, B. Barak (2009). Computational Complexity: A Modern Approach. \textit{Cambridge University Press}.
        \bibitem{Faliszewski} P. Faliszewski (2024). Teoria obliczeń i złożoności obliczeniowej. \textit{Wykłady prowadzone na Akademii Górniczo-Hutniczej w Krakowie}.
        \bibitem{GareyJohnson} M. R. Garey, D. S. Johnson (1979). Computers and Intractability: A Guide to the Theory of NP-Completeness. \textit{W.H. Freeman \& Co}.
        \bibitem{Grochow} J. A. Grochow (2016). NP-hard sets are not sparse unless P = NP: An exposition of a simple proof of Mahaney's Theorem, with applications. \textit{Electronic Colloquium on Computational Complexity, TR16}.
        \bibitem{Sipser} M. Sipser (2013). Introduction to the Theory of Computation (3rd edition). \textit{Cengage Learning}.
    \end{thebibliography}

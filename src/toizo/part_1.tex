...
% Problem kafelkowania kuchni to taki problem, w którym wejściem jest zbiór kwadratowych kafelków $1 \times 1$, z których każdy z boków ma pewien przypisany kolor, a zadaniem jest stwierdzenie, czy kafelkami tymi można wyłożyć nieskończoną planszę w taki sposób, żeby kolory na przylegających bokach były zgodne. Kafelków nie można obracać, ale można ich używać dowolnie wiele razy lub też nie używać wcale.

% \begin{theorem}
%     Problem kafelkowania kuchni jest $\coREclass$-trudny.
% \end{theorem}
